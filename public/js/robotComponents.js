...
function WheelOmni(scene, parent, pos, rot, port, options) {
  var self = this;

  this.parent = parent;

  this.type = 'WheelOmniActuator';
  this.port = port;
  this.options = null;
  ...
  this.init = function() {
    ...
    var wheelMat = scene.getMaterialByID('wheelOmni');
    if (wheelMat == null) {
      var wheelMat = new BABYLON.StandardMaterial('wheelOmni', scene);
      var wheelTexture = new BABYLON.Texture('textures/robot/wheelOmni.png', scene);
      wheelMat.diffuseTexture = wheelTexture;
      wheelMat.specularColor = new BABYLON.Color3(0.2, 0.2, 0.2);
      wheelMat.freeze();
    }
